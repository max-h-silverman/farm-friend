...
| Farmer access | `/admin/farmers` | Invite a farm, authorize a farmer to publish for a farm, see every farmer's access live and withdrawn, revoke it, and issue a replacement private link |
