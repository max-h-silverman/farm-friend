  ...
  beforeEach(async () => {
    ...
    const locations = await client()`
      insert into sales_locations (
        ...
        public_address, public_latitude, public_longitude, season_kind,
        open_hours_kind
      ) values (
        ${farmId}, 'farm_stand', 'Reader Stand', 'America/Los_Angeles', 'visitable',
        'produce', '10 Reader Road', 47.44, -122.46, 'year_round', 'all_day'
      ) returning id
    `;
